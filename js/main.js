...
//===============================================================================================
let heads = $(".header"); // Наша шапка
// let main = $('.main').offset().top;
// let logoH = header.position().top;

$(window).scroll(function() {
	let winScroll = $(this).scrollTop(); // На сколько проскроллили сраницу (число)

	if (winScroll > 70) { // Если проскроллили меньше 1000px от начала страницы
		$(heads).addClass('_black'); // Добавляем класс "black"
	}
	else { // Иначе
		$(heads).removeClass('_black'); // Удаляем класс "black"
	}
});
//==========================================================================================
